...
const web3 = new Web3('https://mainnet.infura.io/v3/dc0b759838f44e9fa4c4ae26d541d6e8');//'https://ropsten.infura.io/v3/dc0b759838f44e9fa4c4ae26d541d6e8');//mainnet
...
module.exports.Send = async(etherAddress, privateKey, toAddress, amount)=>
{
   ...
   // this.AmountFee().then(gasPrice =>{console.log("This fee = " + gasPrice + " eth.");});
    ...
    var transaction = new Tx(rawTransaction, {chain:'mainnet'});//'ropsten'});
