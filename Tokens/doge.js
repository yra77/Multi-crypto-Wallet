...
//address - njbokcv2GT6torfxgUhz99zguNk8zUmEq7
   ...
   let GetBalance = async(sochain_network, walletKey)=>
   {
      let balance = 0;
...
module.exports.CreateKeys = async(str) => 
{
   ...
   //  const walletKey = 'nfXfLSPYR5rVvmf3u8wveoySTT6HGsiQQ7';    
   //  const sochain_network = "DOGETEST"; // real net = DOGE
 
   //  GetBalance(sochain_network, walletKey).then(resolution => 
   // {
   //    console.log(resolution.toString());
   // });

  module.exports.SendDogecoin =  async(recieverAddress, amountToSend)=> 
  {
                    
    const privateKey = 'cmbLFzRJezB1q1GH6BrC7Wafiwfxy2164876tQTk4nFJuq4giaKa';
    const walletKey = 'nfXfLSPYR5rVvmf3u8wveoySTT6HGsiQQ7';    
    const sochain_network = "DOGETEST"; // real net = DOGE
    ...
    const walletKey1 = recieverAddress;
        // const sochain_network = "DOGETEST";

       console.log((await GetBalance(sochain_network, walletKey1)).toString());
