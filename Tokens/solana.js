...
const web3 =  require("@solana/web3.js");
  ...
  // Connect to cluster
  const connection = new web3.Connection(web3.clusterApiUrl('testnet'),'confirmed', );//('devnet');
...
// console.log(web3.clusterApiUrl('devnet'))
   ...
   {
      await connection.getBalance(publicKey).then(resolution => 
      {
   ...
   module.exports.SendSolana = async(from, toAddress, amount) =>
   {
